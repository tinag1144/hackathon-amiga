...
import { UploadCloud, FileText, CheckCircle, Tag, Clock, ArrowRight, Eye, X } from 'lucide-react';
    ...
    <div className="space-y-4 pb-20">
      ...
      <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-editorial border border-[#073b4c]/5 relative overflow-hidden">
        ...
        <p className="text-[11px] sm:text-xs text-[#073b4c]/70 leading-relaxed max-w-xl">
          Arrastrá todo lo que tengas suelto: PDFs de mayoristas, fotos de remitos, Excel o textos de WhatsApp. AMIGA ejecutará el razonamiento de las 5 fases automáticamente.
        </p>
      </div>
      ...
      <label
        ...
        className={`block cursor-pointer bg-white rounded-3xl p-6 text-center transition-all duration-300 border-2 border-dashed shadow-editorial ${
          isDragging
      ...
      >
        ...
        <div className="w-12 h-12 bg-[#118ab2]/10 rounded-2xl flex items-center justify-center mx-auto mb-2.5 text-[#118ab2]">
        ...
        <p className="text-[10px] sm:text-xs text-[#073b4c]/50 mt-0.5">
          Soporta PDFs, Excel (XLSX/CSV), notas de WhatsApp o imágenes
        </p>
        <span className="inline-flex items-center gap-1.5 mt-3 text-[10px] sm:text-xs font-bold text-[#118ab2] bg-[#118ab2]/10 px-4 py-1.5 rounded-full">
